...
public class MovieLineChart extends View {
    ...
    private void drawLineGraph(Canvas canvas) {
        ...
        for (int i = 0; i < moviesStats.size() - 1; i++)
        {
            ...
            //canvas.rotate(-90, startX - offsetText, startY - offsetText);
        ...
        // draw last label
        paint.setColor(Color.WHITE);
        //canvas.rotate(-90, coordMatrix[moviesStats.size() - 1][0] - offsetText * 5, coordMatrix[moviesStats.size() - 1][1] - offsetText);
