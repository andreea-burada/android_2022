...
public class Movie implements Parcelable {
    ...
    protected Movie(Parcel in) {
        ...
        recommended = in.readInt() == 1 ? true : false;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj.getClass() != this.getClass())
            return false;
        Movie obj_movie = (Movie) obj;
        return obj_movie.getTitle().equals(this.title) && obj_movie.getPoster().equals(this.poster);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(recommended == null ? 0 : (recommended == false ? 0 : 1));
    }
    ...
    public Movie(String movieTitle, Genre movieGenre, Date movieRelease, int movieDuration, String moviePoster, boolean movieRecommended) {
