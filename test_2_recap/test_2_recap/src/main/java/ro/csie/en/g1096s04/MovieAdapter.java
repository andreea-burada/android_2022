...
public class MovieAdapter extends  RecyclerView.Adapter<MovieAdapter.MovieHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieHolder holder, int position) {
        ...
        // set checkbox depending on the box office attribute (Called recommended)
        holder.chboxBoxoffice.setChecked(item.getRecommended());
        ...
        else if (item.getPoster() != null)
        {
            ...
            executorService.submit(new DownloadPosterTask(item.getPoster(), uiHandler));
        }
    ...
    public static class MovieHolder extends RecyclerView.ViewHolder {
        ...
        public CheckBox chboxBoxoffice;
        ...
        public MovieHolder(@NonNull View itemView) {
            ...
            chboxBoxoffice = itemView.findViewById(R.id.checkBoxBoxoffice);
