...
public class Movie implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        Movie movie = (Movie) o;
        return title.equals(movie.title) && genre == movie.genre && release.equals(movie.release) && duration.equals(movie.duration);
    }

    @Override
    public int hashCode() {
        return Objects.hash(title, genre, release, duration);
    }
